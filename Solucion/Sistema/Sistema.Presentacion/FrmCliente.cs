    ...
    public partial class FrmCliente : Form
    {
        ...
        private void btnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NPersona.Insertar("Clientes", TxtNombre.Text, CboTipoDocumento.Text, TxtNumeroDocumento.Text, TxtDireccion.Text, TxtTelefono.Text, TxtEmail.Text);
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Rpta = NPersona.Actualizar(Convert.ToInt32(txtID.Text), "Clientes", this.NombreAnt, TxtNombre.Text, CboTipoDocumento.Text, TxtNumeroDocumento.Text, TxtDireccion.Text, TxtTelefono.Text, TxtEmail.Text);
